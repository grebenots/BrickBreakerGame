...
//        brick6 = new Brick(11,2, entitySheet);
    ...
    private synchronized void start() {
        ...
        running = true;
        thread = new Thread(this.getCurrentGame());
        thread.start();
    }
...
//        // End opacity test
    ...
    private void initDisplay() {
        setPreferredSize(new Dimension((int)(WINDOW_SIZE.getX() * SCALE), (int)(WINDOW_SIZE.getY() * SCALE)));
        setMaximumSize(new Dimension(new Dimension((int)(WINDOW_SIZE.getX() * SCALE), (int)(WINDOW_SIZE.getY() * SCALE))));
        setMinimumSize(new Dimension(new Dimension((int)(WINDOW_SIZE.getX() * SCALE), (int)(WINDOW_SIZE.getY() * SCALE))));
